...
#gets the ammount of snowflakes the user wants
#if the input is invalid then the program will ask the user again
while True:
  num = int(input('How many snowflakes do you want(1-15)?'))
  if num < 15 and num > 1:
    break
while True:
